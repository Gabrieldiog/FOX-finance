  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col gap-4 px-6 py-10">
      ...
      <div className="flex flex-col gap-3 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
        ...
        <p>
          Seus dados são seus. Na tela de Conta você pode <strong>exportar tudo</strong> em JSON e{" "}
          <strong>excluir sua conta</strong> a qualquer momento — a exclusão apaga de verdade seus
          lançamentos e seu cadastro.
        </p>
        <p>
